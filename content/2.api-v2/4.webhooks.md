...
- Make sure to ignore requests with an old `Webhook-Timestamp` value
  - Following the spec, we use a custom epoch of `2025-01-01` and a precision of seconds
  - To calculate the current time multiply the header value by `1000`, then add `1735689600000`
